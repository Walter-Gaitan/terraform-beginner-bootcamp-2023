...
2. [Install the Terraform CLI](#install-the-terraform-cli)
...
5. [Workspace Setup](#workspace-setup)
   - [Note: Fix install_terraform_cli name](#note-fix-install_terraform_cli-name)
6. [Creating a New Token in Terraform Cloud](#creating-a-new-token-in-terraform-cloud)
7. [Generating credentials.tfrc.json](#generating-credentialstfrcjson)
8. [Add tf as an alias for terraform](#add-tf-as-an-alias-for-terraform)
